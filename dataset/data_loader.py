...
#         buffer = []
#         skipped_counter = 0 # COunter for fast skipping
...
#                                 # Discard without creating tensors
#                                 buffer = buffer[seq_len:]
#                                 skipped_counter += 1

#                                 # Log progress every 1000 skips so you know it's not dead
#                                 if skipped_counter % 1000 == 0 and accelerator.is_main_process:
